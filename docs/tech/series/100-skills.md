...
| 期数 | 标题 | 发布日期 | 标签 |
|------|------|----------|------|
| **第 10 期** | [Spec Kit - 规范驱动 AI 开发框架](/tech/100-skills-10-spec-kit) | 2026-04-05 | `AI Agent` `规范驱动` `开发方法论` |
...
**规范驱动 AI 开发框架**，告别 vibe coding，让 AI 按规范生成高质量代码！

- ✅ 结构化规范替代模糊需求，减少 AI 理解偏差
- ✅ Living Spec 理念：规范与代码同步演进
- ✅ 支持 Copilot/Claude Code/Cursor 等多 AI 集成

[阅读详细介绍 →](/tech/100-skills-10-spec-kit)
