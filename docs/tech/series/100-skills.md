...
### 🔥 本期推荐：Excalidraw Diagram Generator

**自然语言生成图表神器**，用文字描述即可自动生成专业流程图、架构图、思维导图！

- ✅ 支持 9 种图表类型：流程图、关系图、思维导图、架构图、数据流图、泳道图、类图、时序图、ER 图
- ✅ 自然语言输入，零学习成本，秒级生成
- ✅ 可选 AWS/GCP/Azure 图标库，生成专业云架构图
- ✅ 纯本地执行，无网络请求，最高安全等级

[阅读详细介绍 →](/tech/100-skills-12-excalidraw-diagram-generator)
