...
### 🔥 本期推荐：Text-to-Image-Search

**智能图片搜索神器**，让 AI 代理能够理解你的图片搜索意图！

- ✅ 多引擎搜索（Bing/百度/搜狗）+ 智能排序 + 质量过滤
- ✅ 意图识别（meme/official/wallpaper/avatar）+ 置信度评估
- ✅ 152k+ 下载，自动下载最佳匹配并发送附件

[阅读详细介绍 →](/tech/100-skills-09-text-to-image-search)
